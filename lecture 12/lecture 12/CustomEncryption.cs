...
namespace lecture_12
{
    public static class customEncryption
    {
        ...
        {
            var crypt = new XSystem.Security.Cryptography.SHA256Managed();
        ...
        public static void EncryptText(SymmetricAlgorithm aesAlgorithm, string text, string fileName)
        {
            ...
            System.Security.Cryptography.ICryptoTransform encryptor = aesAlgorithm.CreateEncryptor(aesAlgorithm.Key, aesAlgorithm.IV);
        ...
        public static string DecryptData(SymmetricAlgorithm aesAlgorithm, string fileName)
        {
            ...
            System.Security.Cryptography.ICryptoTransform decryptor = aesAlgorithm.CreateDecryptor(aesAlgorithm.Key, aesAlgorithm.IV);
